            ...
            ILogger log)
        {
           ...
           .AddJsonFile("local.settings.json", optional: true, reloadOnChange: true)
                ...
                using (var connection = new SqlConnection(cnnString))   //  clear memory after excuting
                {
                    ...
                    string Supplierstatus = data?.Supplierstatus;
                    ...
                    connection.Execute($"INSERT INTO [dbo].[Status] (Supplierid,Supplierstatus,ModifiedON) VALUES ('{Supplierid}','{Supplierstatus}','{ModifiedON}')");
